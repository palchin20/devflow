...
const LeftSidebar = async () => {
  ...
  return (
    <section className='pb-16 custom-scrollbar background-light900_dark200 light-border border-r sticky left-0 top-0 h-screen flex flex-col justify-between overflow-y-auto p-6 pt-36 shadow-light-300 dark:shadow-none max-sm:hidden lg:w-[266px]'>
